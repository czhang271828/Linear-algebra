...
**Exercise (optional)** If you know the adjacency matrices $A(G_i)$ for a simple graph $G_i$, then discover the graph operation $\boxplus$ and $\boxtimes$ such that
...
**Exercise 5** Show by $1:1$ correspondence that $(g \oplus g') \otimes f = (g\otimes f) \oplus (g' \otimes f)$. You should firstly clarify the definition of $f \oplus f'$.
