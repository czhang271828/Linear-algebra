...
> [!Tip]
>
> The uniqueness (as we equal $H(z)$ and $H(\overline z)$) of non-zero $J$- and $H$-blocks is governed by $A\overline A$; the uniqueness of the $J(0)$-portion is determined by the rank sequence $\mathrm{rank}(A)$, $\mathrm{rank}(A \overline A)$, $\mathrm{rank}(A \overline A A)$, and so forth.
